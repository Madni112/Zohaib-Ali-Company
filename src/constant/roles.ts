...
export const ROLE_PRESETS: Record<string, RolePreset> = {
  ...
  'Salesman': {
    name: 'Salesman',
    roleKey: 'Salesman',
    description: 'Restricted access: Sale Invoice, Invoice Receipts, Sales Returns, Return Receipt, Debit Notes, and Sales Report.',
    icon: '🛒',
    modules: [
      'dashboards',
      '/Dashboard/Salesman',
